...
**Bar Chart**- Loan distribution across different banking relationship.

**Tree Map**- Visualizes bank loan by Nationality and bank deposits across income levels.
...
**Loan analysis** – distribution by relationship type, nationality, occupation, and income band

**Deposit analysis** – total deposits, foreign currency deposits, and segmentation by nationality and income

**Customer profiling** – gender, joining year, advisor insights
